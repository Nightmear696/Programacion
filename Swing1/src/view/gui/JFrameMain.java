...
public class JFrameMain extends javax.swing.JFrame {
    ...
    private void jButtonValidateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonValidateActionPerformed
        ...
        if (!UserDataValidations.checkFormatDate(birthday)) {
            jLabelErrorBirthday.setText("Incorrect Birthday");
        } else {
            jLabelErrorBirthday.setText("");
        }
        ...
        if (!age.matches("\\d+")) {   
            jLabelErrorAge.setText("Age has to be a number");
            return;
        }
        ...
        if (calculatedAge == -1) {
            jLabelErrorAge.setText("Invalid date");
        } else if (ageValue != calculatedAge) {
        ...
        if (UserDataValidations.checkName(name) && UserDataValidations.checkID(1, nif)
                && UserDataValidations.checkEmail(email) && UserDataValidations.checkFormatDate(birthday)
    ...
    public static void main(String args[]) throws FileNotFoundException {
        ...
        ClassFichero.createFile("user_data_MLB.csv");
    }
